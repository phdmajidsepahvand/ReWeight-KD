...
**REWED** introduces a lightweight and effective framework for **reweighted ensemble knowledge distillation**, designed to enhance diagnostic robustness and domain generalization in medical AI systems.

Unlike conventional single-teacher distillation, REWED leverages a **multi-teacher ensemble**, aggregates their predictive distributions, and models them using a **Dirichlet-guided reweighting mechanism**. This allows the student model to focus more on reliable, high-confidence samples while down-weighting uncertain or ambiguous ones.
